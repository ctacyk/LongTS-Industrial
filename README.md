...
- 📊 Dataset (HuggingFace): https://huggingface.co/datasets/ANTICH/LongTS-Industrial
...
```bash
huggingface-cli download ANTICH/LongTS-Industrial --repo-type dataset --local-dir Data/benchmark_tb
```
